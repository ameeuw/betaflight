...
//    { BOX3DONASWITCH, "3D ON A SWITCH", 38 }, (removed)
    ...
    { BOXMEDIAPLAYERPLAYPAUSE, "MP3 PLAYER PLAY/PAUSE", 50},
    { BOXMEDIAPLAYERNEXT, "MP3 PLAYER NEXT", 51},
    { BOXMEDIAPLAYERPREV, "MP3 PLAYER PREVIOUS", 52},
    { BOXMEDIAPLAYERVOLU, "MP3 PLAYER VOL UP", 53},
    { BOXMEDIAPLAYERVOLD, "MP3 PLAYER VOL DOWN", 54},
};
...
#ifdef USE_MPDEVICE
    BME(BOXMEDIAPLAYERPLAYPAUSE);
    BME(BOXMEDIAPLAYERNEXT);
    BME(BOXMEDIAPLAYERPREV);
    BME(BOXMEDIAPLAYERVOLU);
    BME(BOXMEDIAPLAYERVOLD);
#endif
